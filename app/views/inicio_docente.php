            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-8">
                    ...
                    <p class="lead text-muted mb-4">
                        ...
                        Gestiona tareas, revisa entregas y administra las actividades académicas de tus estudiantes.
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-8">
                    ...
                    <p class="text-muted mb-0">
                        ...
                        Supervisa tareas, revisa entregas y mantén comunicación directa con estudiantes y padres de familia.
                ...
                <div class="col-lg-4 text-end d-none d-lg-block">
                    ...
                    <i class="bi bi-easel-fill info-big-icon"></i>
...
.hero-icon {
    ...
    box-shadow: 0 15px 40px rgba(25,135,84,0.25);
}
